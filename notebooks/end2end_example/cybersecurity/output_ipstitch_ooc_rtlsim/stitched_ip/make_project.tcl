create_project finn_vivado_stitch_proj /tmp/finn_dev_inets/vivado_stitch_proj_najvy035 -part xc7z020clg400-1
set_msg_config -id {[BD 41-1753]} -suppress
set_property ip_repo_paths [list $::env(FINN_ROOT)/finn-rtllib/memstream /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_0_593z5fwa /tmp/finn_dev_inets/code_gen_ipgen_MVAU_hls_0_f_dmdrd7/project_MVAU_hls_0/sol1/impl/ip /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_1_63tdc11i /tmp/finn_dev_inets/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_l2l_bgfx /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_2_8v7fnydr /tmp/finn_dev_inets/code_gen_ipgen_MVAU_hls_1_r33w7i07/project_MVAU_hls_1/sol1/impl/ip /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_3_n46lak6l /tmp/finn_dev_inets/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_7untxat0 /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_4_sjxc6e4l /tmp/finn_dev_inets/code_gen_ipgen_MVAU_hls_2_f8wr4zgw/project_MVAU_hls_2/sol1/impl/ip /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_5_ashtkf_q /tmp/finn_dev_inets/code_gen_ipgen_MVAU_hls_3_c0g99ut5/project_MVAU_hls_3/sol1/impl/ip /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_6_p0gcz2_q] [current_project]
update_ip_catalog
create_bd_design "finn_design"
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_0_593z5fwa/Q_srl.v
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_0_593z5fwa/StreamingFIFO_rtl_0.v
...
set_property -dict [list CONFIG.DEPTH {60} CONFIG.WIDTH {1280} CONFIG.INIT_FILE {/tmp/finn_dev_inets/code_gen_ipgen_MVAU_hls_0_f_dmdrd7/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MVAU_hls_0/MVAU_hls_0_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_1_63tdc11i/Q_srl.v
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_1_63tdc11i/StreamingFIFO_rtl_1.v
create_bd_cell -type module -reference StreamingFIFO_rtl_1 StreamingFIFO_rtl_1
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_l2l_bgfx/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_l2l_bgfx/dwc.sv
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_l2l_bgfx/StreamingDataWidthConverter_rtl_0.v
create_bd_cell -type module -reference StreamingDataWidthConverter_rtl_0 StreamingDataWidthConverter_rtl_0
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_2_8v7fnydr/Q_srl.v
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_2_8v7fnydr/StreamingFIFO_rtl_2.v
...
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {128} CONFIG.INIT_FILE {/tmp/finn_dev_inets/code_gen_ipgen_MVAU_hls_1_r33w7i07/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MVAU_hls_1/MVAU_hls_1_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_3_n46lak6l/Q_srl.v
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_3_n46lak6l/StreamingFIFO_rtl_3.v
create_bd_cell -type module -reference StreamingFIFO_rtl_3 StreamingFIFO_rtl_3
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_7untxat0/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_7untxat0/dwc.sv
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_7untxat0/StreamingDataWidthConverter_rtl_1.v
create_bd_cell -type module -reference StreamingDataWidthConverter_rtl_1 StreamingDataWidthConverter_rtl_1
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_4_sjxc6e4l/Q_srl.v
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_4_sjxc6e4l/StreamingFIFO_rtl_4.v
...
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {128} CONFIG.INIT_FILE {/tmp/finn_dev_inets/code_gen_ipgen_MVAU_hls_2_f8wr4zgw/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MVAU_hls_2/MVAU_hls_2_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_5_ashtkf_q/Q_srl.v
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_5_ashtkf_q/StreamingFIFO_rtl_5.v
...
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {8} CONFIG.INIT_FILE {/tmp/finn_dev_inets/code_gen_ipgen_MVAU_hls_3_c0g99ut5/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MVAU_hls_3/MVAU_hls_3_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_6_p0gcz2_q/Q_srl.v
add_files -norecurse /tmp/finn_dev_inets/code_gen_ipgen_StreamingFIFO_rtl_6_p0gcz2_q/StreamingFIFO_rtl_6.v
...
validate_bd_design
save_bd_design
make_wrapper -files [get_files /tmp/finn_dev_inets/vivado_stitch_proj_najvy035/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/finn_design.bd] -top
add_files -norecurse /tmp/finn_dev_inets/vivado_stitch_proj_najvy035/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/hdl/finn_design_wrapper.v
set_property top finn_design_wrapper [current_fileset]
ipx::package_project -root_dir /tmp/finn_dev_inets/vivado_stitch_proj_najvy035/ip -vendor xilinx_finn -library finn -taxonomy /UserIP -module finn_design -import_files
...
set fp [open /tmp/finn_dev_inets/vivado_stitch_proj_najvy035/all_verilog_srcs.txt w]
